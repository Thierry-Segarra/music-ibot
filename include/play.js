  ...
  async play(song, message) {
    ...
    try {
      var playingMessage = await queue.textChannel.send(
        ...
        console.log(`Next musique`, { title: song.title})
      );
      ...
      //console.error(error); // remplace le message d'erreur qui sert a rien pour des utilisateur
      console.log(`Lecture de la musique `, { title: song.title},` est imposible veiller verifier si cette musique peut etre diffuser sur Discord`)
    }
