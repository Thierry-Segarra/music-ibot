  ...
  async execute(message, args) {
    ...
    if (playlistEmbed.description.length >= 2048)
      playlistEmbed.description =
        playlistEmbed.description.substr(0, 2007) + i18n.__mf("playlist.playlistCharLimit");

    message.channel.send(i18n.__("playlist.startedPlaylist", { author: message.author }), playlistEmbed);
    console.log(`playliste mis par `, { author: message.author.username }, playlistEmbed)
